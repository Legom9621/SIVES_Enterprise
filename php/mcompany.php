                    ...
                    <li class="mb-1 nav-item">
                        ...
                        <div class="collapse" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showRegisterc('registerc'); closeUserMenu();">Registrar Compañia.</a></li>
                                <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showUpdate('update'); closeUserMenu();">Actualizar Datos.</a></li>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (isPostDates) {
                        ...
                        var menu = document.getElementById('menu');
                            ...
                            // ocultaciones específicas (si existen) 
                            var elUpdate = document.getElementById("registerc");
                            if (elUpdate) elUpdate.style.display = 'none';

                            // Mostrar el formulario requerido (Próximos)
                            var target = document.getElementById(formId === 'update' ? 'update' : formId);
                            if (target) {
                                target.style.display = 'block';
                            }
                            if (menu) menu.style.display = 'block';
