                    ...
                    <ul class="list-unstyled ps-0 nav nav-pills flex-column mb-auto">
                        ...
                        <li class="mb-1 nav-item">
                            ...
                            <div class="collapse" id="dashboard-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showNext('Frmproximos'); return false;">Próximos a vencer.</a></li>
                                    <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showExpirate('Frmvencidos'); return false;">Vencidos.</a></li>
                                    <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showDate('Frmvencidosfec'); return false;">Por período.</a></li>
