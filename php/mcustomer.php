...
if (!function_exists('pintarMenu')) {
    function pintarMenu($perfil, $username) {
        ...
        try {
            $user_id = $_SESSION['user_id'] ?? null; // CORRECCIÓN: usr_id no user_id
                    ...
                    <ul class="list-unstyled ps-0 nav nav-pills flex-column mb-auto">
                        ...
                        <li class="mb-1 nav-item">
                            ...
                            <div class="collapse" id="dashboard-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="/expiration.php" class="btn btn-rounded">Gestión de Vencimientos</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="mb-1 nav-item">
                            ...
                            <div class="collapse show" id="account-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showManage('manage')">Gestionar cliente.</a></li>
                                <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showRegister('register')">Agregar cliente.</a></li>
