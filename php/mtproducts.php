                        ...
                        <li class="mb-1 nav-item">
                            ...
                            <div class="collapse show" id="products-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li style="display: block;"><a href="#" class="btn btn-rounded" onclick="showManage('manage')">Tipo de Seguros.</a></li>
                                    <li style="display: none;"><a href="#" class="btn btn-rounded">Agregar.</a></li>
