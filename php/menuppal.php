 ...
 * $perfil = nivel del usuario (1 a 5)
 * $username = nombre del usuario en sesión
 */
// ====================== INCLUDES BASE ====================== //
...
$usuarios_Inactivos = obtenerUsuariosInactivos($con);
...
function pintarMenu($perfil, $username) {
    ...
    // OBTENER FOTO DEL USUARIO DESDE LA BASE DE DATOS - CORREGIDO PARA PDO
    global $con;
    $fotolog = "";
    $logo = "";
    $icono = "";
        ...
        <div id="sidebar" class="d-flex flex-column  flex-shrink-0 p-3 bg-body-tertiary">
            ...
            <section id="menu" style="display: block;">
                <ul class="list-unstyled ps-0 nav nav-pills flex-column mb-auto">
                    ...
                    <!-- VENCIMIENTOS - Perfiles 1,2,3,4 (no 5) -->
                    <?php //if ($perfil >= 1 && $perfil <= 5) { ?>
                    <li class="mb-1 nav-item">
                    ...
                    <!-- AGENCIAS - Todos los perfiles (1-5) -->
                    <li class="mb-1 nav-item">
                        ...
                        <div class="collapse" id="orders-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="/agency.php" class="btn btn-rounded">Gestión de Agencias</a></li>
                            </ul>
                        </div>
                    </li>

                    <!-- PRODUCTOS - Todos los perfiles (1-5) -->
                    <li class="mb-1 nav-item">
                    ...
                    <!-- CLIENTES - Todos los perfiles (1-5) -->
                    <li class="mb-1 nav-item">
            ...
            <!-- SECCIÓN USUARIO - MEJORADA CON SCROLL AUTOMÁTICO -->
            <div class="dropdown position-relative" id="userDropdown">
                ...
                onclick="toggleUserMenu()" id="dropdownUserLink">
                    ...
                    <strong style="font-size:large">Usuario: <br><?php echo htmlspecialchars($_SESSION['username']); ?></strong>
                </a>
                <ul class="dropdown-menu text-small shadow" id="userDropdownMenu" style="min-width: 220px;">
                    ...
                    ?>
                        ...
                        <li><hr class="btn btn-rounded dropdown-divider my-1"></li>
                        <li><a class=" btn btn-rounded dropdown-item py-2" href="#" onclick="showRegister('register'); closeUserMenu();">Nuevo usuario</a></li>
                        <li><a class="btn btn-rounded dropdown-item py-2" href="#" onclick="showActive('active'); closeUserMenu();">Activar usuario</a></li>
                        <li><a class="btn btn-rounded dropdown-item py-2" href="#" onclick="showDesactive('desactive'); closeUserMenu();">Desactivar usuario</a></li>
                        <li><a class="btn btn-rounded dropdown-item py-2" href="/php/function.php" onclick="closeUserMenu();">Crear Backup</a></li>
                        <li><hr class="btn btn-rounded dropdown-divider my-1"></li>
                        <li>
                            <a class="dropdown-item bg-danger text-center py-2" href="/php/logout.php?nik=<?php echo $user_id; ?>" style="border-radius: 3px;">
                                <strong>Salir</strong>
                            </a>
                        </li>
                    <?php } else { ?>
