                    ...
                    <ul class="list-unstyled ps-0 nav nav-pills flex-column mb-auto">
                        ...
                        <li class="mb-1 nav-item">
                            ...
                            <div class="collapse show" id="products-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li style="display: block;"><a class="btn btn-rounded" href="#" onclick="showManage('manage')">Gestionar Seguros</a></li>
                                    <li style="display: block;"><a class="btn btn-rounded" href="/php/typeproducts.php">Tipos de Seguros</a></li>
